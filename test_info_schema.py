...
# Try querying information_schema.tables via REST API
url = "https://ouceojtrgihnuaetmrcb.supabase.co/rest/v1/information_schema.tables?select=table_name"
...
url2 = "https://ouceojtrgihnuaetmrcb.supabase.co/rest/v1/information_schema.tables?select=table_name"
